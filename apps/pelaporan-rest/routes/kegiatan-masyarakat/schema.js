...
const shared = {
    ...
    definitions: {
        ...
        pelaporanKegiatanForm: {
            "title": "Pelporan Form Kegiatan Masyarakat",
            "type": "object",
            "properties": {
                "kegiatan__jenis_kegiatan_id": {
                    "type": "number"
...
const getSchema = {
    description: "Get Laporan Kegiatan Masyarakat",
...
const postSchema = {
    "description": "Add Laporan Kegiatan Masyarakat",
    tags: ["laporan-kegiatan"],
...
const deleteSchema = {
    description: "Delete Laporan Kegiatan Masyarakat",
    tags: ["laporan-kegiatan"],
    params: {
        id: { type: "number" }
    },
...
const putSchema = {
    description: "Update Laporan Kegiatan Masyarakat",
    tags: ["laporan-kegiatan"],
    params: {
        id: { type: "number" }
    },
