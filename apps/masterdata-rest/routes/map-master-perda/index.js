...
module.exports = async function (server, opts) {
    ...
    const DbSetJenisPenyelesaian = () => server.models.MapMasterPerdaJenispenyelesaian

    server.get('/jenis-kegiatan', { schema: getJenisKegiatanSchema }, async function (request, reply) {
        return await server.odata.replyPaging(request, reply, DbSetJenisKegiatan())
    })
    server.get('/jenis-penyelesaian', { schema: getJenisPenyelesaianSchema }, async function (request, reply) {
        return await server.odata.replyPaging(request, reply, DbSetJenisPenyelesaian())
    })
