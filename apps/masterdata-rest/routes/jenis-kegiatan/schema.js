...
const getSchema = {
    description: "Get Jenis Kegiatan",
    tags: ["jenis-kegiatan"],
    querystring: defaultPageQueryString,
    response: {
        200: reply200(shared.definitions.jenisKegiatanDto)
    }
}
...
const postSchema = {
    "description": "Add Jenis Kegiatan",
    tags: ["jenis-kegiatan"],
    body: {},
    response: {
        200: reply200(shared.definitions.jenisKegiatanDto),
...
const deleteSchema = {
    description: "Delete Jenis Kegiatan",
    tags: ["jenis-kegiatan"],
    params: {
        id: { type: "number" }
    },
...
const putSchema = {
    description: "Update Jenis Kegiatan",
    tags: ["jenis-kegiatan"],
    params: {
        id: { type: "number" }
    },
